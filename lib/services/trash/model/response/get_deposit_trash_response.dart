...
DepositTrashResponse depositTrashResponseFromJson(String str) => DepositTrashResponse.fromJson(json.decode(str));

String depositTrashResponseToJson(DepositTrashResponse data) => json.encode(data.toJson());
...
class DepositTrashResponse {
    ...
    factory DepositTrashResponse.fromJson(Map<String, dynamic> json) => DepositTrashResponse(
        success: json["success"],
        code: json["code"],
        message: json["message"],
        data: List<DepositTrash>.from(json["data"].map((x) => DepositTrash.fromJson(x))),
    );
