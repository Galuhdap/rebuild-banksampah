...
class SetorSampahScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final DepositTrashController controller = Get.put(DepositTrashController());

    return Scaffold(
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          showDepositTrashDialog(context, AppConstants.LABEL_DEPOSIT_TRASH);
        },
                              ...
                              children: [
                                ...
                                Center(
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                        borderRadius:
                                            BorderRadius.circular(AppSizes.s2),
                                ...
                                InkWell(
                                  onTap: () {
                                    showDepositTrashDialog(context,
                                        AppConstants.LABEL_EDIT_DEPOSIT_TRASH);
                                  },
                                  child: Row(
                                    children: [
                                      Icon(
