...
class LoadingStatusRegisterScreen extends StatelessWidget {
  final String label;

  const LoadingStatusRegisterScreen({super.key, required this.label});
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
        child: Scaffold(
          body: Obx(
            () {
              return controller.isLoadingUpdateStatusUser.value
                  ? Center(
                      child: SizedBox(
                        width: 300,
                        height: 300,
