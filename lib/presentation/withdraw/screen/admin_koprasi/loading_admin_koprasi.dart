...
class LoadingAdminKoprasi extends StatelessWidget {
  final String label;
  const LoadingAdminKoprasi({super.key, required this.label});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Obx(
        () {
          return controller.isLoadingAddtWithdrawAdminKopraso.value
              ? Center(
                  child: SizedBox(
                    width: 300,
                    height: 300,
              ...
              : Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      Button.filled(
                          onPressed: () {
                            Get.offAllNamed(AppRoutes.withdrawFundAdminKoprasi);
                          },
