...
class DetailWithdrawFundsAdminKoprasiScreen extends StatelessWidget {
  final DataWithdrawAdminKoprasi data;
  const DetailWithdrawFundsAdminKoprasiScreen({super.key, required this.data});
          ...
          Row(
            ...
            children: [
              ...
              Text(
                data.nameAdmin,
                style:
                    Get.textTheme.bodyLarge!.copyWith(fontSize: AppSizes.s12),
              ),
            ],
          ),
          AppSizes.s60.height,
